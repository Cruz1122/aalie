...
const ERROR_PATTERNS: { pattern: RegExp | ((s: string) => boolean); key: LlmErrorKey }[] = [
  ...
  { pattern: /timeout|timed out|deadline exceeded|DEADLINE_EXCEEDED/i, key: "llmErrorTimeout" },
  { pattern: /500|internal server|server error|503|service unavailable/i, key: "llmErrorServer" },
  { pattern: /blocked|blocked_content|SAFETY|content filter/i, key: "llmErrorBlocked" },
  { pattern: /unavailable|connection refused|fetch failed|network/i, key: "llmErrorUnavailable" },
