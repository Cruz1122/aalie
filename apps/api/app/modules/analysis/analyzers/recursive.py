...
class RecursiveAnalyzer(BaseAnalyzer):
    ...
    def _extract_recurrence(
        ...
        if use_characteristic or use_iteration:
            ...
            ) == "worst" and self._detect_quicksort_range_partition(proc_def, recursive_calls)
    ...
    def _classify_guard(
        ...
        *,
        ...
        line = (
            condition.get("pos", {}).get("line") if isinstance(condition.get("pos"), dict) else None
        )
    ...
    def _classify_case_variability(
        ...
        if profile.has_pruning and profile.data_dependent_guards:
            return CaseVariabilityDecision(
                ...
                reason_codes=reasons + ["has_pruning_true", "data_dependent_guards_present"],
            )
