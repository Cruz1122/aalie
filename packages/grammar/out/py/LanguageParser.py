...
class LanguageParser(Parser):
    ...
    class ArrayParamContext(ParserRuleContext):
        ...
        def arrayDim(self, i: int = None):
            if i is None:
                return self.getTypedRuleContexts(LanguageParser.ArrayDimContext)
            else:
                return self.getTypedRuleContext(LanguageParser.ArrayDimContext, i)
